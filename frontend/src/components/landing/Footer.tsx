    ...
    <footer className="w-full bg-atlas-cream border-t border-atlas-black/10 py-10 px-6 sm:px-12 lg:px-16 text-atlas-black">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 text-xs font-semibold text-atlas-black/80">
          <a href="#features" className="hover:text-atlas-black transition-colors">
            Features
          </a>
          <a href="#architecture" className="hover:text-atlas-black transition-colors">
            Architecture
          </a>
          <a href="#use-cases" className="hover:text-atlas-black transition-colors">
            Use Cases
          </a>
          <a href="#quickstart" className="hover:text-atlas-black transition-colors">
            Quickstart
          </a>
          <Link href="/dashboard/metrics" className="hover:text-atlas-black transition-colors">
            Metrics
          </Link>
          <Link href="/docs" className="hover:text-atlas-black transition-colors">
            Docs
          </Link>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-right">
          ...
          <div className="flex items-center gap-3 text-atlas-black/70">
            {/* GitHub */}
            <a
              href="https://github.com/Abhinav-0709/atlas"
              target="_blank"
              rel="noreferrer"
